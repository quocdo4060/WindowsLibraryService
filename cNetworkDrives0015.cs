...
namespace aejw.Network
{
    ...
    public class NetworkDrive
    {
        ...
        private static readonly IPerfLog PerfLog = PerfLogManager.GetLog(typeof (NetworkDrive));
#endif
        private static readonly ILog Logger = LogManager.GetLogger(typeof (NetworkDrive));
        ...
        private bool lf_SaveCredentials;
        ...
        private bool ls_PromptForCredentials;
